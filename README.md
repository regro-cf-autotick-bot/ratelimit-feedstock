...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/ratelimit-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=11652&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/ratelimit-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `ratelimit` can be installed with:

```
conda install ratelimit
```

It is possible to list all of the versions of `ratelimit` available on your platform with:
